...
import {
    DamageList,
    ReturnList,
} from "../../features/returnBooks/ReutrnApi";
...
import DamageBooksTable from "./DamageBooksTable";

const DamageTabView = () => {
    const { damageList, damagePagination, getDamageStatus } =
                ...
                <Table>
                    ...
                    {damageList?.length > 0 && (
                        <TableFooterPagination
                            ...
                            tableList={damagePagination?.total}
